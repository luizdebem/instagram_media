...
class _InstagramMediaState extends State<InstagramMedia> {
  ...
  Widget build(BuildContext context) {
    String urlOne =
        "https://api.instagram.com/oauth/authorize/?client_id=${widget.appID}&redirect_uri=https://httpstat.us/200&scope=instagram_graph_user_profile,instagram_graph_user_media&response_type=code&hl=en";
